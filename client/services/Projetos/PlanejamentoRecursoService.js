...
import {
  EXCLUIR_PLANEJAMENTO_RECURSO_EXECUCAO_MUTATION,
  EXCLUIR_PROJETO_TAREFA_MUTATION,
  PLANEJAMENTO_RECURSOS_QUERY,
  SALVAR_PLANEJAMENTO_RECURSO_EXECUCAO_MUTATION,
...
export const salvarPlanejamentoExecucao = (input) =>
  execute(SALVAR_PLANEJAMENTO_RECURSO_EXECUCAO_MUTATION, { input }, true);

export const excluirPlanejamentoExecucao = (input) =>
  execute(EXCLUIR_PLANEJAMENTO_RECURSO_EXECUCAO_MUTATION, { input }, true);
