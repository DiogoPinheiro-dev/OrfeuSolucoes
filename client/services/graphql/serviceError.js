...
const classifyError = ({ error, graphQLError, originalError, fieldErrors }) => {
...
export const toServiceError = (error, fallback = DEFAULT_MESSAGE) => {
    ...
    const type = classifyError({ error, graphQLError, originalError, fieldErrors });
