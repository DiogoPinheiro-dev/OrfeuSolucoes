...
export default function ProjectEditorModal({
    ...
    return (
        ...
        >
            ...
            {mode === "create" && <FeedbackMessage type="info" compact>Novos projetos começam no ciclo Em orçamento. Aprove o orçamento em Orçamento do projeto para que ele passe automaticamente para Rascunho.</FeedbackMessage>}
