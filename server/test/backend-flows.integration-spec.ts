...
function createWorld(): TestWorld {
  ...
  const solucaoBootstrapService = new SolucaoBootstrapService(prismaService, funcionalidadeAcaoService, solucaoAcessoService);
  ...
  const gruposService = new GruposUsuariosService(prismaService, solucoesService, grupoUsuarioBootstrapService, grupoUsuarioPermissaoService);
  const empresaAcessoService = new EmpresaAcessoService(solucoesService);
  ...
  const empresasService = new EmpresasService(prismaService, empresaCatalogService);
  ...
  const usersService = new UsersService(prismaService, userCatalogService, userPasswordService);
  ...
  const chamadoConfiguracaoService = new ChamadoConfiguracaoService(prismaService, solucoesService, chamadoAuthorizationService);
  const chamadoResponsavelService = new ChamadoResponsavelService(prismaService, chamadoAuthorizationService);
